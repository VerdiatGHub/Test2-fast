...
if os.getenv("PLANNER_AGENT_MODEL_TYPE") == "openrouter":
    llm = ChatOpenAI(
        model=os.getenv("PLANNER_AGENT_MODEL_ID"),
        temperature=0.3,
        openai_api_key=os.getenv("OPENROUTER_API_KEY"),
        openai_api_base="https://openrouter.io/api/v1",
        default_headers={
            "HTTP-Referer": "https://github.com/skyiron/neuralagentAI",
            "X-Title": "NeuralAgent AI",
        }
    )
elif os.getenv("PLANNER_AGENT_MODEL_TYPE") == "9router":
    llm = ChatOpenAI(
        model=os.getenv("PLANNER_AGENT_MODEL_ID"),
        temperature=0.3,
    ...
    llm = AzureChatOpenAI(
        azure_deployment=os.getenv("PLANNER_AGENT_MODEL_ID", 'gpt-4.1-mini'),
